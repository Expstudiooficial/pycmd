...
LANGUAGES = [
    ...
    {"id": "c", "name": "C", "extension": ".c", "indent": "    ",
     "about": "Runs in the app, on the C interpreter it carries."},
    {"id": "go", "name": "Go", "extension": ".go", "indent": "\t",
     "about": "Runs in the app. Tabs, because gofmt uses tabs."},
    {"id": "rust", "name": "Rust", "extension": ".rs", "indent": "    ",
     "about": "Runs in the app, on the Rust interpreter it carries."},
    {"id": "shell", "name": "Shell", "extension": ".sh", "indent": "    ",
     "about": "POSIX sh, which is what Android gives you."},
    {"id": "json", "name": "JSON", "extension": ".json", "indent": "  ",
     "about": "Settings and data. The commas are put in for you."},
]
